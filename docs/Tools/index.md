...
<div class="section-hero tools-hero">
  <h1>🧰 Tools</h1>
  <p>常见工具的配置安装步骤与使用记录</p>
  <div class="section-stats">
    <span class="stat-item">⚙️ 环境配置</span>
    <span class="stat-item">📝 实战记录</span>
  </div>
</div>

<div class="section-subtitle">🚀 开发与系统工具</div>
...
<a class="note-card cyan" href="EDA/index/">
  <span class="card-icon">🔧</span>
  <div class="card-title">EDA 工具链配置</div>
