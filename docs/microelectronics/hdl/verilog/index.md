...
**当位宽不一致时**
![](assets/Verilog基础/位宽不一致.webp)
==只需要记住，赋值时的常量为32b（计算机数据宽度）==

### 1.9 存储器语法
![](assets/Verilog基础/存储器.webp)

### 1.10 变量的符号
![](assets/Verilog基础/变量符号.webp)
...
##### ⑧ 条件运算符
![](assets/Verilog基础/条件运算符.webp)

##### ⑨ 操作符优先级
![](assets/Verilog基础/操作符优先级.webp)
...
![](assets/Verilog基础/case.webp)
**在casez语句中，==? 和z== 被当作无关值。**
![](assets/Verilog基础/casez.webp)
**在casex语句中，==?，z 和x== 被当作无关值。**
![](assets/Verilog基础/casex.webp)
...
![](assets/Verilog基础/display.webp)
![](assets/Verilog基础/monitor.webp)
![](assets/Verilog基础/monitor举例.webp)
...
**文件输出举例**
![](assets/文件IO/文件输出举例.webp)
**读写任务函数**
![](assets/文件IO/读写任务函数.webp)
