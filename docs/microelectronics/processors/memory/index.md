...
!!! question "多字节block"
    以上我们没有提到的是**多字节block**的写入、读出情况，详见：[多字节block的读写详情](multi-bytes-block/index.md)
...
> 多级缓存的 Miss Penalty 和 CPI 计算方法详见：[多级缓存的性能计算](multilevel-cache-performance/index.md)
...
（也可参见：[Memory Hierarchy](memory-hierarchy-flow/index.md)）
...
<a class="note-card blue" href="memory-hierarchy-flow/">
  <span class="card-icon" aria-hidden="true">🗂️</span>
  <div class="card-title">存储层次访问流程</div>
  <p class="card-desc">沿着访存过程理解各级存储的配合。</p>
</a>

<a class="note-card purple" href="multi-bytes-block/">
  <span class="card-icon" aria-hidden="true">🧱</span>
  <div class="card-title">多字节缓存块</div>
  <p class="card-desc">缓存块与字节寻址的关系。</p>
</a>

<a class="note-card green" href="multilevel-cache-performance/">
  <span class="card-icon" aria-hidden="true">📈</span>
  <div class="card-title">多级缓存性能</div>
  <p class="card-desc">多级缓存的访问时间与性能分析。</p>
</a>
