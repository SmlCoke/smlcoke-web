...
> 更详细的解说可以参考 [迭代边界-详细讲解](iteration-bound-explained/index.md)
...
<a class="note-card blue" href="iteration-bound-explained/">
  <span class="card-icon" aria-hidden="true">🪜</span>
  <div class="card-title">迭代边界</div>
  <p class="card-desc">DSP算法受限的天王老子</p>
</a>

<a class="note-card purple" href="sampling-clock-iteration-periods/">
  <span class="card-icon" aria-hidden="true">⏱️</span>
  <div class="card-title">采样、时钟与迭代周期</div>
  <p class="card-desc">区分不同周期及其与吞吐率的关系。</p>
</a>
