...
- `docs/tools/writing/style-guide/index.md`
  - 给后续写文章留了规范
...
- 首页 `docs/index.md`
- 栏目页，例如 `docs/microelectronics/digital-circuits/vlsi/index.md`
- 公式密集页，例如 `docs/microelectronics/processors/hardware-software-interface/index.md`
- 工具说明页，例如 `docs/tools/...`
- 图片密集页，例如 `docs/microelectronics/hdl/verilog/index.md`
