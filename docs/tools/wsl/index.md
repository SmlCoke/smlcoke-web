...
[系统目录结构、环境变量配置说明文档](../linux/filesystem/index.md)
[Linux 基础命令使用文档](../linux/commands/index.md)
...
**配置步骤**：[venv 与 conda 配置方法文档](../../programming/python/environments/venv/index.md)


## III. 代理

**WSL2 使用日志**：
  **配置方法步骤**：[代理配置方法文档](proxy/index.md)
...
**配置方法步骤**：[Yosys 配置方法文档](../../microelectronics/eda/yosys/index.md)
...
**配置方法步骤**：[Symbiyosys, boolector, z3 配置方法文档](../../microelectronics/eda/symbiyosys/index.md)
...
<a class="note-card blue" href="proxy/">
  <span class="card-icon" aria-hidden="true">🌐</span>
  <div class="card-title">WSL 代理配置</div>
  <p class="card-desc">WSL 环境中的网络代理配置记录。</p>
</a>
